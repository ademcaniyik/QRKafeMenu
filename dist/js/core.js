            ...
            callback: function(v) {
                ...
                if (g)
                    ...
                    for (; P < N;) {
                        ...
                        var F = "";
                        if (n ? (h && (b(S[P]), s && b(E[P])), s && (F += '<div class="user">' + y(E[P].innerHTML) + "</div>"), F += '<p class="tweet">' + y(S[P].innerHTML) + "</p>", r && (F += m ? '<p class="timePosted"><a href="' + D[P] + '">' + $[P].getAttribute("aria-label") + "</a></p>" : '<p class="timePosted">' + $[P].getAttribute("aria-label") + "</p>")) : (S[P].textContent, s && (F += '<p class="user">' + E[P].textContent + "</p>"), F += '<p class="tweet">' + S[P].textContent + "</p>", r && (F += '<p class="timePosted">' + $[P].textContent + "</p>")), u && (F += '<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + O[P] + '" class="twitter_reply_icon"' + (h ? ' target="_blank" rel="noopener">' : ">") + 'Reply</a><a href="https://twitter.com/intent/retweet?tweet_id=' + O[P] + '" class="twitter_retweet_icon"' + (h ? ' target="_blank" rel="noopener">' : ">") + 'Retweet</a><a href="https://twitter.com/intent/favorite?tweet_id=' + O[P] + '" class="twitter_fav_icon"' + (h ? ' target="_blank" rel="noopener">' : ">") + "Favorite</a></p>"), p && void 0 !== _[P] && void 0 !== x(_[P]))
                ...
                }(I), o = !1, i.length > 0 && (T.fetch(i[0]), i.splice(0, 1))
            }
        };
        ...
        function(e) {
            ...
            function q() {
                if (!this.state.isDestroyed) {
                    ...
                    e.offsets.reference = I(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = j(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = M(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = R(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                }
            }
